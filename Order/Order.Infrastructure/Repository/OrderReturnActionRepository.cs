    ...
    public class OrderReturnActionRepository : IOrderReturnActionRepository
    {
        ...
        public async Task<BaseResponse<long>> Create(OrderReturnAction orderReturnAction)
        {
            try
            {
                ...
                new MySqlParameter("@returnaction", orderReturnAction.ReturnAction),
                new MySqlParameter("@createdBy", orderReturnAction.CreatedBy),
                new MySqlParameter("@createdAt", orderReturnAction.CreatedAt)
        ...
        public async Task<BaseResponse<long>> Update(OrderReturnAction orderReturnAction)
        {
            try
            {
                ...
                new MySqlParameter("@id", orderReturnAction.Id),
                new MySqlParameter("@returnaction", orderReturnAction.ReturnAction),
                new MySqlParameter("@modifiedBy", orderReturnAction.ModifiedBy),
                new MySqlParameter("@modifiedAt", orderReturnAction.ModifiedAt)
        ...
        public async Task<BaseResponse<long>> Delete(OrderReturnAction orderReturnAction)
        {
            try
            {
                ...
                new MySqlParameter("@id", orderReturnAction.Id),
                new MySqlParameter("@deletedby", orderReturnAction.DeletedBy),
                new MySqlParameter("@deletedat", orderReturnAction.DeletedAt)
        ...
        public async Task<BaseResponse<List<OrderReturnAction>>> Get(OrderReturnAction orderReturnAction, int PageIndex, int PageSize, string Mode)
        {
            try
            {
                ...
                new MySqlParameter("@isDeleted", orderReturnAction.IsDeleted),
