...
namespace API_Gateway.Controllers.Seller
{
    ...
    [ApiController]
    public class SellerProductCollectionController : ControllerBase
    {
        ...
        public SellerProductCollectionController(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public ActionResult<ApiHelper> Get(int? pageindex = 1, int? pageSize = 10)
        {
            ...
            var response = helper.ApiCall(URL, EndPoints.ManageCollectionMapping + "?PageIndex=" + pageindex + "&PageSize=" + pageSize, "GET", null);
            ...
            if (baseResponse1.code == 200)
            {
                ...
                baseResponse.Data = dataresponse.Select(details => new ManageCollectionMappingLibrary
                {
                    ...
                    SaleMRP = details.SaleMRP,
                    SaleSellingPrice = details.SaleSellingPrice,
                    ...
                    IsSellerOptIn = details.IsSellerOptIn,
                    TotalVariant = details.TotalVariant,
        ...
        [Authorize(Roles = "Admin, Seller")]
        public ActionResult<ApiHelper> GetByCollectionId(int collectionId)
        {
            BaseResponse<ManageCollectionMappingLibrary> baseResponse1 = new BaseResponse<ManageCollectionMappingLibrary>();
            var response = helper.ApiCall(URL, EndPoints.ManageCollectionMapping + "?CollectionId=" + collectionId, "GET", null);
            baseResponse1 = baseResponse1.JsonParseList(response);
            if (baseResponse1.code == 200)
            {
                var dataresponse = (List<ManageCollectionMappingLibrary>)baseResponse1.Data;
        ...
        [HttpGet("byProductId")]
        [Authorize(Roles = "Admin, Seller")]
        public ActionResult<ApiHelper> GetByProductId(int productId)
        {
            BaseResponse<ManageCollectionMappingLibrary> baseResponse1 = new BaseResponse<ManageCollectionMappingLibrary>();
