...
namespace API_Gateway.Controllers.Admin
{
    ...
    [ApiController]
    public class SellerWiseCommissionController : ControllerBase
    {
        ...
        public SellerWiseCommissionController(IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public ActionResult<ApiHelper> Create(CommissionDTO model)
        {
            ...
            //{
            //    url = "?chargeson=" + model.ChargesOn + "&SellerID=" + model.SellerID + "&onlySeller=" + true;
            //}
            //else
            //{
            //}
        ...
        public ActionResult<ApiHelper> Delete(int id)
        {
            ...
            else
            {
                ...
                var GetResponse = api.ApiCall(CatalogueUrl, EndPoints.Product + "?PathIds=" + chargesLibrary[0].CatID, "GET", null);
                ...
                if (proemplist.Any())
                {
                    ...
                    bool _availbaleInCategory = commissionCharges.AvailableCommissionInSpecificCategory(Convert.ToInt32(chargesLibrary[0].CatID), CatalogueUrl,false);
        ...
        public ActionResult<ApiHelper> BySearch(string? searchText = null, string? SellerID = null, int pageIndex = 1, int pageSize = 10)
        {
            string url = string.Empty;
            ...
            var response = api.ApiCall(CatalogueUrl, EndPoints.CommissionCharges + "?PageIndex=" + pageIndex + "&PageSize=" + pageSize + "&onlySeller=" + true + url, "GET", null);
            ...
            //datalist = commissionChargeslst.Where(x => x.CategoryName.ToLower().Contains(searchText.ToLower()) || x.SellerName.ToLower().Contains(searchText.ToLower())).ToList();
            if (datalist.Count > 0)
            {
            ...
            //else
            //{
            //    var response = api.ApiCall(CatalogueUrl, EndPoints.CommissionCharges + "?PageIndex=" + pageIndex + "&PageSize=" + pageSize + "&onlySeller=" + true, "GET", null);
            //    baseResponse = baseResponse.JsonParseList(response);
            //    List<CommissionChargesLibrary> templist = baseResponse.Data as List<CommissionChargesLibrary>;
        ...
        //{
        //    var response = api.ApiCall(CatalogueUrl, EndPoints.CommissionCharges + "?chargeson=" + chargesOn + "&PageIndex=" + pageIndex + "&PageSize=" + pageSize + "&onlySeller=" + true, "GET", null);
        //    baseResponse = baseResponse.JsonParseList(response);
        //    List<CommissionChargesLibrary> templist = baseResponse.Data as List<CommissionChargesLibrary>;
        //    var pag = baseResponse.pagination;
        //    var message = baseResponse.Message;
