...
{
    public class ManageLendingpageProductSectionDTO
    {
        ...
        public IEnumerable<LendingPageproductSection>? productSections { get; set; }
    }
    public class LendingPageproductSection
    {
