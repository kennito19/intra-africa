...
const AllGridFile = ({ layoutsInfo, section }) => {
  const renderComponent = () => {
    switch (layoutsInfo?.layout_class) {
      case 'grid_1by1-1':
        return <Grid1by1_1 layoutsInfo={layoutsInfo} section={section} />
      case 'grid_1-2by2':
        return <Grid1_2by2 layoutsInfo={layoutsInfo} section={section} />
      case 'grid_2by2-1':
        return <Grid2by2_1 layoutsInfo={layoutsInfo} section={section} />
      case 'grid_1-2by1':
        return <Grid1_2by1 layoutsInfo={layoutsInfo} section={section} />
      case 'grid_1-1by2':
        return <Grid1_1by2 layoutsInfo={layoutsInfo} section={section} />
      case 'grid_2by1-1':
        return <Grid2by1_1 layoutsInfo={layoutsInfo} section={section} />
      case 'grid_1by2-1':
        return <Grid1by2_1 layoutsInfo={layoutsInfo} section={section} />
      case 'grid_1by2-2by1':
        return <Grid1by2_2by1 layoutsInfo={layoutsInfo} section={section} />
      case 'grid_2by1-1by2':
        return <Grid2by1_1by2 layoutsInfo={layoutsInfo} section={section} />
      case 'grid_1-3-1':
        return <Grid1_3_1 layoutsInfo={layoutsInfo} section={section} />
      case 'grid_3-1-3':
        return <Grid3_1_3 layoutsInfo={layoutsInfo} section={section} />
      case 'grid_1-2-1':
        return <Grid1_2_1 layoutsInfo={layoutsInfo} section={section} />
      case 'grid_2-1-2':
        return <Grid2_1_2 layoutsInfo={layoutsInfo} section={section} />
      case 'gallery-col-4':
        return <Grid_col_four layoutsInfo={layoutsInfo} section={section} />

      case 'row-grid':
        return <CustomGrid layoutsInfo={layoutsInfo} section={section} />
      default:
        return null
    }
  }
